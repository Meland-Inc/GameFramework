...
{
    internal sealed partial class ServerDataTableManager : GameFrameworkModule, IServerDataTableManager
    {
        /// <summary>
        /// 数据表。
        /// </summary>
        ...
        private sealed class DataTable<T> : DataTableBase, IDataTable<T> where T : class, IDataRow, new()
        {
            ...
            internal override void SetDataProviderHelper(IDataProviderHelper<DataTableBase> dataProviderHelper)
            {
            ...
            public override void ReadData(string dataTableAssetName)
            {
                ReadData(dataTableAssetName, 0, null);
            }
            ...
            public override void ReadData(string dataTableAssetName, int priority)
            {
                ReadData(dataTableAssetName, priority, null);
            }
            ...
            /// <param name="dataTableAssetName">数据表资源名称。</param>
            /// <param name="userData">用户自定义数据。</param>
            public override void ReadData(string dataTableAssetName, object userData)
            {
                ReadData(dataTableAssetName, 0, userData);
            }
            ...
            /// <param name="priority">加载数据表资源的优先级。</param>
            /// <param name="userData">用户自定义数据。</param>
            public override void ReadData(string dataTableAssetName, int priority, object userData)
            {
                try
                {
                    if (!m_DataProviderHelper.ReadData(this, dataTableAssetName, null, userData))
                    {
                        throw new GameFrameworkException(Utility.Text.Format("Load data failure in data provider helper, data asset name '{0}'.", dataTableAssetName));
                    }
                }
                catch (Exception)
                {
            ...
            public override bool ParseData(string dataTableString)
            {
                return ParseData(dataTableString, null);
            }
            ...
            /// <param name="userData">用户自定义数据。</param>
            /// <returns>是否解析数据表成功。</returns>
            public override bool ParseData(string dataTableString, object userData)
            {
                ...
                try
                {
                    return m_DataProviderHelper.ParseData(this, dataTableString, userData);
                }
                catch (Exception exception)
                {
                    if (exception is GameFrameworkException)
            ...
            /// <returns>是否解析数据表成功。</returns>
            public override bool ParseData(byte[] dataTableBytes)
            {
            ...
            /// <param name="userData">用户自定义数据。</param>
            /// <returns>是否解析数据表成功。</returns>
            public override bool ParseData(byte[] dataTableBytes, object userData)
            {
                if (dataTableBytes == null)
                {
                    throw new GameFrameworkException("Data bytes is invalid.");
            ...
            /// <returns>是否解析数据表成功。</returns>
            public override bool ParseData(byte[] dataTableBytes, int startIndex, int length)
            {
            ...
            /// <param name="userData">用户自定义数据。</param>
            /// <returns>是否解析数据表成功。</returns>
            public override bool ParseData(byte[] dataTableBytes, int startIndex, int length, object userData)
            {
                if (m_DataProviderHelper == null)
                {
                    throw new GameFrameworkException("You must set data helper first.");
                ...
                if (startIndex < 0 || length < 0 || startIndex + length > dataTableBytes.Length)
                {
                ...
                try
                {
                    return m_DataProviderHelper.ParseData(this, dataTableBytes, startIndex, length, userData);
                }
                catch (Exception exception)
                {
                    if (exception is GameFrameworkException)
